...
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.ViewHolder> {
    ...
    private void sendUserToNoConnectionActivity() {
        Intent toNoConnectionActivity = new Intent(context, NoConnectionActivity.class);
            ...
            itemView.setOnClickListener(v -> {
                if (itemView.getContext() instanceof NewsActivity) {
                    ...
                    activity.getSupportFragmentManager().
                            beginTransaction().setCustomAnimations(R.anim.slide_in_down, R.anim.slide_out_down,R.anim.slide_in_down,R.anim.slide_out_up).
